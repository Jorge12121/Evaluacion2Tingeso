...
//        Optional<Tarifas> tarifaOpt = tarifasService.obtenerTarifaActiva();
...
//        double tarifaBase = tarifasService.obtenerTarifaBase(idTarifa, numeroVueltas);
//        double precioBase = cantidadPersonas * tarifaBase;
//
//        double descuentoPersonas = AplicarDescuentoPersonas(precioBase, cantidadPersonas);
...
//        Reserva reserva = reservasRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Reserva no encontrada"));
